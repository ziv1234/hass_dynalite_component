...
from dynalite_devices_lib.const import (
    ...
    CONF_TEMPLATEOVERRIDE, DEFAULT_COVERCHANNELCLASS, DEFAULT_COVERFACTOR, CONF_TRIGGER, 
    CONF_CHANNELCOVER, CONF_NODEFAULT, CONF_LOGLEVEL, CONF_FADE, CONF_DEFAULT, CONF_POLLTIMER, CONF_AUTODISCOVER, CONF_ALL
)
