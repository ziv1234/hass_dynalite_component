...
async def test_light_setup(hass, enable_custom_integrations, mock_device):
...
async def test_unload_config_entry(hass, enable_custom_integrations, mock_device):
...
async def test_remove_config_entry(hass, enable_custom_integrations, mock_device):
