...
async def test_cover_setup(hass, enable_custom_integrations, mock_device):
...
async def test_cover_without_tilt(hass, enable_custom_integrations, mock_device):
...
async def test_cover_positions(hass, enable_custom_integrations, mock_device):
