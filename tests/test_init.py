...
async def test_service_request_area_preset(hass, enable_custom_integrations):
...
async def test_service_request_channel_level(hass, enable_custom_integrations):
...
async def test_async_setup_bad_config1(hass, enable_custom_integrations):
...
async def test_async_setup_bad_config2(hass, enable_custom_integrations):
